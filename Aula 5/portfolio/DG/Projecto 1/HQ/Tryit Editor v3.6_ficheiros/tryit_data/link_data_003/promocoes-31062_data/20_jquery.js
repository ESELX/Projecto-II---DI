...
;(function ($) {
  ...
  $.fn.bxSlider = function (options) {
    ...
    var setup = function () {
      ...
      slider.controls.el = $('<div class="bx-controls container" />');
    ...
    var appendControls = function () {
      slider.controls.next = $('<a class="bx-next icon-seta-direita-fina" href=""></a>');
      slider.controls.prev = $('<a class="bx-prev icon-seta-esquerda-fina" href=""></a>');
    ...
    var initTicker = function () {
      ...
      if (slider.settings.tickerHover && !slider.usingCSS) {
        ...
        slider.viewport.hover(function () {
          ...
          var totalDimens = 0;
          slider.children.each(function (index) {
            totalDimens += slider.settings.mode == 'horizontal' ? $(this).outerWidth(true) : $(this).outerHeight(true) + 5;
          });
    ...
    el.destroySlider = function () {
      ...
      if (slider.settings.pagerCustom === '') slider.pagerEl.remove();
